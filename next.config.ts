        ...
        headers: [
          ...
          },
          {
            ...
            value: process.env.NODE_ENV === 'production' 
              ? "default-src 'self'; script-src 'self' 'unsafe-inline' https://www.googletagmanager.com https://www.google-analytics.com https://www.clarity.ms https://*.clarity.ms; style-src 'self' 'unsafe-inline' https://fonts.googleapis.com; font-src 'self' https://fonts.gstatic.com; img-src 'self' data: https: blob: https://*.clarity.ms; media-src 'self' https://streefi-public-assets.s3.ap-south-1.amazonaws.com https://videos.streefi.in; connect-src 'self' https://www.google-analytics.com https://*.clarity.ms https://www.googletagmanager.com https://*.ingest.sentry.io; frame-src 'self' https://www.googletagmanager.com https://*.clarity.ms; worker-src 'self' blob:; object-src 'none'; base-uri 'self';"
              : "default-src 'self'; script-src 'self' 'unsafe-inline' 'unsafe-eval' https://www.googletagmanager.com https://www.google-analytics.com https://www.clarity.ms https://*.clarity.ms; style-src 'self' 'unsafe-inline' https://fonts.googleapis.com; font-src 'self' https://fonts.gstatic.com; img-src 'self' data: https: blob: https://*.clarity.ms; media-src 'self' https://streefi-public-assets.s3.ap-south-1.amazonaws.com https://videos.streefi.in; connect-src 'self' https://www.google-analytics.com https://*.clarity.ms https://www.googletagmanager.com https://*.ingest.sentry.io https://o4510702448803840.ingest.de.sentry.io; frame-src 'self' https://www.googletagmanager.com https://*.clarity.ms; worker-src 'self' blob:; object-src 'none'; base-uri 'self';"
          }
        ],
      },
    ];
