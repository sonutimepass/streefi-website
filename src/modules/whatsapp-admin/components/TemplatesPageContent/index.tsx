 ...
 * 
 * Shows:
 * - Template manager with sync, test send, and template list
 */
          ...
          <div className="flex items-center justify-between h-16">
            <div className="flex items-center space-x-4">
              ...
              <div className="flex-1">
                <h1 className="text-lg sm:text-xl font-bold text-gray-900">Templates</h1>
                <p className="text-xs text-gray-600 hidden sm:block">Manage WhatsApp message templates</p>
              </div>
            </div>
