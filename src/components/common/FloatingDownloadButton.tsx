...
export default function FloatingDownloadButton() {
  ...
  useEffect(() => {
    ...
    const animate = () => {
      // Smooth interpolation with 0.15 factor for smooth movement
      ...
      setScrollPosition(Math.round(currentScrollRef.current));
      setIsVisible(currentScrollRef.current > 350);
  ...
  return (
    <div 
      className="absolute bottom-8 left-[30px] z-[999] hidden md:block 2xl:left-[50px]"
      style={{
        top: `${scrollPosition + window.innerHeight - 150}px`,
        maxWidth: '200px',
        width: '200px',
        maxHeight: '80px',
        height: '80px',
    ...
    >
      <div 
        className="flex flex-row gap-5 items-center justify-center h-[100px] w-[250px] rounded-[24px] bg-white p-[10px] xl:h-[130px] xl:w-[320px] 2xl:h-[150px] 2xl:w-[340px]"
        style={{ boxShadow: '0px 34px 34px 0px #00000047' }}
      >
        {/* Left side - Logo and text */}
        <div className="flex flex-col items-center justify-center gap-2">
          <div className="flex flex-col items-center justify-center">
            <p className="text-[15px] font-bold text-[#3C172A] xl:text-[20px] 2xl:text-xl tracking-tight">
              DOWNLOAD 
            </p>
            <p className="text-[20px] font-bold text-[#06C167] xl:text-[24px] 2xl:text-[28px] tracking-tight">
              STREEFI
            </p>
          </div>
        </div>
        ...
        <div className="flex flex-col gap-3 xl:scale-105">
          ...
          >
            <svg viewBox="0 0 48 48" xmlns="http://www.w3.org/2000/svg" fill="#FFFFFF" stroke="#FFFFFF" className="h-[18px] w-auto xl:h-[20px] 2xl:h-[22px]">
          ...
          <a
            ...
            className="flex h-[36px] w-[130px] items-center justify-center gap-2 rounded-xl bg-black hover:bg-gray-800 transition-colors xl:h-[42px] xl:w-[140px] 2xl:h-[52px] 2xl:w-[170px]"
          >
            <svg fill="#FFFFFF" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" stroke="#FFFFFF" className="h-[18px] w-auto xl:h-[20px] 2xl:h-[22px]">
            ...
            <span className="text-[10px] font-semibold text-white xl:text-[11px] 2xl:text-[12px]">App Store</span>
          </a>
        </div>
      </div>
    </div>
