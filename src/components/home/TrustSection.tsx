...
export default function TrustSection() {
  ...
  const TestimonialCard = ({ testimonial }: { testimonial: typeof testimonialsRow1[0] }) => (
    <div className="flex-shrink-0 w-[280px] bg-white backdrop-blur-sm rounded-xl p-5 border-2 border-gray-200 hover:border-[#06c167] transition-all duration-300 hover:shadow-lg group shadow-md">
      {/* Quote Icons */}
  ...
  return (
    <section id="reviews" className="relative py-5 bg-white overflow-hidden">
      {/* Background Pattern */}
      ...
      <div className="max-w-5xl mx-auto relative z-10 px-3">
        {/* Stats Section */}
        <div ref={sectionRef} className="bg-gradient-to-r from-green-50 to-emerald-50 rounded-2xl p-6 md:p-8 mb-20 border-2 border-green-200 shadow-md">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            <div className="text-center">
              <div className="text-3xl md:text-4xl font-bold text-gray-900 mb-1">{counts.vendors}+</div>
              <div className="text-gray-700 text-base">Active Vendors</div>
            </div>
            <div className="text-center">
              <div className="text-3xl md:text-4xl font-bold text-gray-900 mb-1">{counts.Stories}+</div>
              <div className="text-gray-700 text-base">Stories Listed</div>
            </div>
            <div className="text-center">
              <div className="text-3xl md:text-4xl font-bold text-gray-900 mb-1">{counts.explorers}K+</div>
              <div className="text-gray-700 text-base">Food Explorers</div>
            </div>
            <div className="text-center">
              <div className="text-3xl md:text-4xl font-bold text-gray-900 mb-1">{counts.rating}★</div>
              <div className="text-gray-700 text-base">Average Rating</div>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="relative px-3 md:px-10 lg:px-16">
        {/* Section Header */}
