...
export default function VendorGrid({ vendors, loading }: VendorGridProps) {
                ...
                <div className="p-3">
                  ...
                  <div className="flex items-center justify-between mb-3">
                    <div className="flex items-center space-x-0.5">
                      {[...Array(5)].map((_, i) => (
                        <svg 
                          key={`${vendor._id}-star-${i}`}
                          className={`w-3 h-3 ${i < Math.floor(vendor.rating) ? 'text-[#ff6b35]' : 'text-gray-300'}`}
                          fill="currentColor"
                          viewBox="0 0 20 20"
                        >
                    ...
                    <p className="text-gray-600 text-xs">({vendor.reviews})</p>
                  </div>
