...
import PolicyNavigation from '@/components/common/PolicyNavigation';
        ...
        <main className="min-h-screen bg-gray-50 text-gray-800">
            ...
            <div className="max-w-4xl mx-auto px-4 py-18 space-y-8">
                ...
                <div id="stall-booking" className="policy-section scroll-mt-24">
                    ...
                    <p className="text-justify">Bookings can be canceled or modified up to [Insert Time Limit] before your scheduled time without a penalty. Cancellations made after this period may incur a fee. Any changes to your booking, including stall selection or timing, must be made prior to the stipulated cut-off time and are subject to availability. Streefi and the Vendor reserve the right to deny changes based on operational constraints.</p>
